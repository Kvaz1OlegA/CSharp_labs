...
namespace lab6
{
    ...
    {
        public delegate void MoneyState(string message);
        public event MoneyState AddMoney;

        private int money;
        public bool Discovery { get; set; }
        public int Money { get { return money; } }
        public void Award(int money)
        {
            this.money += money;
            AddMoney?.Invoke($"Sum {money} was added. Was {this.money - money}. Now {this.money}");
        }
